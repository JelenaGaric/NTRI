...
class CriticNetwork(nn.Module):
    def __init__(self, learning_rate, input_dims, n_actions, layer1_size=256, layer2_size=256,
        ...
        self.layer1 = nn.Linear(self.input_dims[0] + n_actions, self.layer1_size)
...
class ActorNetwork(nn.Module):
    def __init__(self, learning_rate, input_dims, max_action, layer1_dims=256, layer2_dims=256,
                 n_actions=2, file_name='actor', save_path='tmp/sac'):
